...
% Last Modified by GUIDE v2.5 04-May-2018 23:32:13
...
function edit2_CreateFcn(obj, edata, handles)
...
curs = exec(conn,['SELECT * ' ...
    'FROM IrisAdmin.dbo.AdminAccount']);
curs = fetch(curs);
numrows = rows(curs);
usernamePwdata = curs.Data;

guiUsername = get(handles.edit1,'String');
guiPassword = get(handles.edit2,'String');
validUser = false;
for k=1:numrows
    username = usernamePwdata{k,2};
    password = usernamePwdata{k,3};
